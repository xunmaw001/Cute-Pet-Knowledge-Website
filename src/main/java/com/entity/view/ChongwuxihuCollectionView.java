...
public class ChongwuxihuCollectionView extends ChongwuxihuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String chongwuxihuCollectionValue;
	...
	public ChongwuxihuCollectionView() {

	}

	public ChongwuxihuCollectionView(ChongwuxihuCollectionEntity chongwuxihuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chongwuxihuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChongwuxihuCollectionValue() {
				return chongwuxihuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChongwuxihuCollectionValue(String chongwuxihuCollectionValue) {
				this.chongwuxihuCollectionValue = chongwuxihuCollectionValue;
			}
